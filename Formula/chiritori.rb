class Chiritori < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/piyoppi/chiritori/releases/download/v1.0.0/chiritori-darwin-arm64.tar.gz"
      sha256 "0ab440d132569c234cae5f96122e22e184fb72c87128c4dbfc98102f2359bb95"
    end

    on_intel do
      url "https://github.com/piyoppi/chiritori/releases/download/v1.0.0/chiritori-darwin-x86_64.tar.gz"
  ...
  on_linux do
    on_arm do
      url "https://github.com/piyoppi/chiritori/releases/download/v1.0.0/chiritori-linux-arm64-musl.tar.gz"
      sha256 "a343d8476b248e68ba246aa52a6943955c57cde61b37ba27e2438e9b78042158"
    end

    on_intel do
      url "https://github.com/piyoppi/chiritori/releases/download/v1.0.0/chiritori-linux-x86_64-musl.tar.gz"
